...
// source: /Users/richard/www/instante/php-test-suite/tests/Meta/../sandbox/tests/../app/config/local.neon 

class Container_052bab5f15 extends Nette\DI\Container
{
	...
	{
		return new Container_052bab5f15_Nette_Bridges_ApplicationLatte_ILatteFactoryImpl_latte_latteFactory($this);
	}
...
final class Container_052bab5f15_Nette_Bridges_ApplicationLatte_ILatteFactoryImpl_latte_latteFactory implements Nette\Bridges\ApplicationLatte\ILatteFactory
{
	private $container;


	public function __construct(Container_052bab5f15 $container)
	{
